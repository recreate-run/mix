        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://x.com/intent/user?screen_name=sarath_suresh_m" className="text-muted-foreground hover:text-primary">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Questions? Feedback? Reach out to us through GitHub or Twitter.
            </p>
            <p className="text-sm text-muted-foreground">
