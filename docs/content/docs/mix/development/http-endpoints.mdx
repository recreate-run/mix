...
Mix provides a REST API interface for programmatic integration and automation. The recommended way to interact with the server is through the generated [client SDKs](/docs/mix/sdk).
