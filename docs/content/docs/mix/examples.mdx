...
2. **Set up Mix** following the [quickstart guide](/docs/mix/quickstart)
3. **Configure required tools** based on your chosen workflow
...
<Cards>
  ...
  <Card title="DevTools" href="/docs/mix/devtools">
