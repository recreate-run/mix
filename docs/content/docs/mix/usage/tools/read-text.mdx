---
title: Read Text
description: Reads a text file from the local filesystem or from a URL. Assume this tool is able to read all local text files on the machine and download text c...
---
