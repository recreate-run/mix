---
title: Read Text
description: Reads a text file from the local filesystem. Assume this tool is able to read all local text files on the machine. If the User provides a path to a...
---
