---
title: Read Media
description: Analyzes multimedia files using AI. If the user provides a path to a file assume that path is valid. It is okay to read a file that does not exist;...
---
