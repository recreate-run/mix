...
> Mix is "Claude Code" for multimodal tasks. A desktop app that integrates with professional tools like Blender, Figma, and Logic Pro to automate creative and analytical workflows.
...
[Complete quickstart guide (5 minutes) →](/docs/backend/quickstart)
...
<Cards>
  <Card title="Quickstart Guide" href="/docs/backend/quickstart">
...
<Cards>
  ...
  <Card title="Python SDK" href="/docs/backend/sdk-overview">
