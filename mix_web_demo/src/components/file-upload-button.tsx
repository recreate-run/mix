...
export function FileUploadButton({
	...
	const handleFileSelect = async () => {
		if (PlatformFeatures.hasNativeFilePicker()) {
			// Desktop-only feature: Native file picker using Tauri
			// This is disabled in the web version as @tauri-apps packages are not available
			console.warn("Native file picker is only available in desktop version");
			onUploadError?.("Native file picker is only available in desktop version. Please use the browser file picker instead.");
			return;
