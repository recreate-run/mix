...
- All downloaded files must be added to the appropriate subfolder in the input folder (e.g., downloaded videos go to `input/videos/`, images to `input/images/`, etc.).
