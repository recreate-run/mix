Use this tool when you are in plan mode and have finished presenting your plan and are ready to create multimedia content. This will prompt the user to exit plan mode.
